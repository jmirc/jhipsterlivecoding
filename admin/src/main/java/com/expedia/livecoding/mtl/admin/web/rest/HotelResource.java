...
import com.expedia.livecoding.mtl.admin.web.rest.util.PaginationUtil;
...
public class HotelResource {
    ...
    @RequestMapping(value = "/hotels",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Hotel>> getAll(@RequestParam(value = "page" , required = false) Integer offset,
                                  @RequestParam(value = "per_page", required = false) Integer limit)
        throws URISyntaxException {
        Page<Hotel> page = hotelRepository.findAll(PaginationUtil.generatePageRequest(offset, limit));
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/hotels", offset, limit);
